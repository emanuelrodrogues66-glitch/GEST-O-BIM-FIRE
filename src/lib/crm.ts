...
export type Lead = {
  ...
  /** Como o cliente vai pagar — vira as parcelas do projeto ao vender. */
  forma_pagamento: string | null
  entrada: number | null
  parcelas: number | null
  /** Cobrança já lançada no sistema externo de cobrança. */
  rag_cadastrado: boolean
  rag_cadastrado_em: string | null
 ...
 *
 * Lista fechada de propósito: "pix", "PIX" e "Pix" digitados à mão viram três
 * formas diferentes, e o relatório financeiro para de conseguir agrupar.
 */
