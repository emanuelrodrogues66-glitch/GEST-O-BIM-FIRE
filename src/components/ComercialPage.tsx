                          ...
                          >
                            ...
                            */}
                            ...
                            <div className="flex items-center gap-1.5 mt-1">
                              ...
                              {l.forma_pagamento && !l.rag_cadastrado && (
                                <span className="text-[9px] px-1 rounded bg-amber-100 text-amber-800" title="Falta lançar a cobrança no RAG 3">
                                  RAG 3
                                </span>
                              )}
                              {l.retorno_em && (
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="text-[10px] uppercase text-slate-400 border-b border-slate-200">
                      ...
                      <th className="text-center">RAG 3</th>
                    ...
                    {visiveis.map((l) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Sem forma definida nao ha o que lancar: o traco separa isso do atraso. */}
                          <td className="text-center">
                            {l.rag_cadastrado ? (
                              <span className="text-emerald-600" title={`Lançado${l.rag_cadastrado_em ? ' em ' + dataBR(l.rag_cadastrado_em) : ''}`}>✓</span>
                            ) : l.forma_pagamento ? (
                              <span className="text-amber-600" title={`${l.forma_pagamento} — falta lançar no RAG 3`}>●</span>
                            ) : (
                              <span className="text-slate-300" title="Sem forma de pagamento definida">—</span>
                            )}
                          </td>
